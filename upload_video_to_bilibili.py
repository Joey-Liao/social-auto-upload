...
def upload_video_to_bilibili(filepath, account_file, num_for_day, daily_times):
    ...
    file_num = len(files)
    timestamps = generate_schedule_time_next_day(file_num, num_for_day, daily_times, timestamps=True)
